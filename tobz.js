...
module.exports = tobz = async (tobz, message) => {
    try {
        ...
        const ownerNumber = '6285259622026@c.us'
        ...
        // FUNCTION
                ...
                if (chats.match("anjing") || chats.match("gblk") || chats.match("tolol") || chats.match("kntl")) {
                    if (!isGroupAdmins) {
                        ...
                        }).catch(() => tobz.sendText(from, `Untung BOT Bukan Admin, Kalo Jadi Admin Udah Aku Kick Tuh! 😑`))
                    } else {
...
${desc}`)
        ...
        case '#owner':
        case '#creator':
            tobz.sendContact(chatId, `6285259622026@c.us`)
...
➸ *Wilayah:* +${region_name}`
        ...
        case '#help':
            ...
            break
        case '#botgroup':
            tobz.reply(from, `Link Group BOT : https://chat.whatsapp.com/GuTgpLCAHADEZDprhbiU6L\nJangan Lupa Join Ya Kak ${pushname}`, id)
            break
        case '#groupmenu':
